...
export class LocalFilesController {
  ...
  async uploadQuestionFile(@UploadedFiles(new UploadFilePipe({
    allowedFileTypes: [FileMimeTypeEnum.GIF, FileMimeTypeEnum.JPEG, FileMimeTypeEnum.PNG, FileMimeTypeEnum.SVG],
    ...
    if (err) {
      return new ResponseObject(HttpStatus.BAD_REQUEST, 'Upload question file failed!', null, err);
    }
    return new ResponseObject(HttpStatus.OK, 'Upload question file success!', localFiles, null);
  }
}
